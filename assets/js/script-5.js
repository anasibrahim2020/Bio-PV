  ...
  return new Promise(resolve=>{
    ...
    overlay.innerHTML = `
      <style>
        ...
        #app-confirm-overlay .acd-btn{border:none;border-radius:12px;padding:11px 24px;font-family:'Plus Jakarta Sans','IBM Plex Sans Arabic',sans-serif;font-size:13.5px;font-weight:800;cursor:pointer;transition:transform .12s ease,box-shadow .15s ease,background .15s ease;}
...
function renderCommentsOverlay(i){
  ...
  overlay.innerHTML = `
    <style>
      ...
      #app-comments-overlay .cmt-link{background:none;border:none;font-family:'Plus Jakarta Sans','IBM Plex Sans Arabic',sans-serif;font-size:12px;font-weight:800;color:var(--teal);cursor:pointer;padding:3px 7px;border-radius:8px;}
      ...
      #app-comments-overlay textarea{width:100%;box-sizing:border-box;border:1.5px solid var(--border);border-radius:12px;padding:10px 12px;font-family:'Plus Jakarta Sans','IBM Plex Sans Arabic',sans-serif;font-size:13.5px;resize:vertical;outline:none;background:#fff;}
      ...
      #app-comments-overlay .cmt-submit{align-self:flex-start;background:var(--teal);color:#fff;border:none;border-radius:12px;padding:10px 22px;font-family:'Plus Jakarta Sans','IBM Plex Sans Arabic',sans-serif;font-size:13.5px;font-weight:800;cursor:pointer;box-shadow:0 10px 22px -6px rgba(21,36,56,.28);transition:filter .15s ease;}
